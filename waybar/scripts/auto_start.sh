...
ln -s ~/.config/waybar/color_themes/color_theme_catppuccin.css catppuccin/colorTheme.css
ln -s ~/.config/waybar/color_themes/color_theme_catppuccin_latte.css catppuccin-latte/colorTheme.css
ln -s ~/.config/waybar/color_themes/color_theme_ethereal.css ethereal/colorTheme.css
ln -s ~/.config/waybar/color_themes/color_theme_everforest.css everforest/colorTheme.css
...
ln -s ~/.config/waybar/color_themes/color_theme_osaka_jade.css osaka-jade/colorTheme.css
ln -s ~/.config/waybar/color_themes/color_theme_ristretto.css ristretto/colorTheme.css
ln -s ~/.config/waybar/color_themes/color_theme_rosePine.css rose-pine/colorTheme.css
